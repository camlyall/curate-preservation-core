...
// generateUserToken generates a user token for the given user
// https://pydio.com/en/docs/developer-guide/post-aauthtokenimpersonate
func generateUserToken(ctx context.Context, client *utils.HttpClient, address, username, adminToken string, timeout time.Duration) (string, error) {
...
// revokeUserToken revoke a user token from the Cells server.
// https://pydio.com/en/docs/developer-guide/delete-aauthtokenstokenid
func revokeUserToken(ctx context.Context, client *utils.HttpClient, address, token, userToken string) error {
...
// getUserData gets the user data for a given user.
// https://pydio.com/en/docs/developer-guide/post-auser
func getUserData(ctx context.Context, client *utils.HttpClient, address, token, user string) (UserData, error) {
...
func downloadNode(ctx context.Context, cecPath, address, username, token, cellsSrc, dest string) ([]byte, error) {
...
// Returns the output of the command
func uploadNode(ctx context.Context, cecPath, address, username, token, src, cellsDest string) ([]byte, error) {
